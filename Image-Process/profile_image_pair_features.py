...
layout:
  - profiles come from data-for-project/nomalized_profiles.csv
  - images are reused from Image-Process/downloaded_images
...
Typical usage:
  ...
  2. Build pair-level image features from a pair CSV
     python profile_image_pair_features.py pair-features \
       --pairs-csv ..\data-for-project\candidate_pairs_advanced.csv \
       --output-csv ..\data-for-project\candidate_pairs_advanced_with_image_features.csv
"""
...
DEFAULT_PROFILES_CSV = PROJECT_DIR / "data-for-project" / "nomalized_profiles.csv"
DEFAULT_PAIRS_CSV = PROJECT_DIR / "data-for-project" / "candidate_pairs_advanced.csv"
DEFAULT_IMAGE_DIR = SCRIPT_DIR / "downloaded_images"
DEFAULT_CACHE_PATH = SCRIPT_DIR / "image_cache.pkl"
DEFAULT_OUTPUT_CSV = PROJECT_DIR / "data-for-project" / "candidate_pairs_advanced_with_image_features.csv"
