...
$excludeFile = Join-Path $scriptDir "leakage_excluded_features_strict.txt"
$chunkedRoot = Join-Path $scriptDir "stage9_pipeline_chunked"
$trainingRoot = Join-Path $scriptDir "stage10_13_training_noleak_strict"
...
Write-Host ""
Write-Host ">>> Running strict no-leak training pipeline"
