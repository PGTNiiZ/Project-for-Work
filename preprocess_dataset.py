...
def load_all_profiles(base_path: str = "data/data/Dataset-LinkSocial") -> pd.DataFrame:
...
def run_preprocessing_pipeline(
    base_path: str = "data/data/Dataset-LinkSocial",
    ...
    df_clean.to_csv(os.path.join(output_dir, "all_profiles_cleaned.csv"), index=False)
