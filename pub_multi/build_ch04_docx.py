...
DEFAULT_INPUT = ROOT / "doc" / "ch04_results_formal_th.md"
DEFAULT_OUTPUT = ROOT / "out" / "บทที่4_ผลการวิจัยและอภิปรายผล.docx"
MAX_IMAGE_WIDTH = Cm(14.2)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build Chapter 4 Word document from markdown and local figures.")
