...
DEFAULT_PROFILES_FILE = PROJECT_ROOT / "data" / "processed" / "all_profiles_cleaned.csv"
DEFAULT_ONTOLOGY_FILE = PROJECT_ROOT / "data" / "ontology" / "location_ontology.csv"
DEFAULT_OUTPUT_FILE = PROJECT_ROOT / "data" / "processed" / "location_mapping.csv"
