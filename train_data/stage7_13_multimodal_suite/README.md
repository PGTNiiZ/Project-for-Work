...
- Profiles: `data_for_project/normalized_profiles_with_profile_id.csv`
- Base leak-safe logic: `train_data/stage7_8_rebuilt_experiment_hybrid/run_rebuilt_pipeline.py`
- Local profile images: `image_process/downloaded_images`
